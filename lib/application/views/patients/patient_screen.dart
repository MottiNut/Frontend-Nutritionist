...
import 'categorys_patogys/news/pat/DiabetesPatientsScreen.dart';
import 'categorys_patogys/news/pat/hipertencion_patients_screen.dart';
import 'categorys_patogys/news/pat/obecity_patient_screen.dart';
    ...
    switch (category.routeName) {
      ...
      case '/hipertension':
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => HipertencionPatientsScreen(),
          ),
        );
        break;
      case '/obesidad':
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => ObesityPatientScreen(),
        ),
      );
      /*Navigator.push(
          context,
