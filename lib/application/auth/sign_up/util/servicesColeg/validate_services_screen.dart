...
class _ValidationScreenState extends State<ValidationScreen>
  ...
  Future<bool> _detectCardSide() async {
    try {
      ...
      // Patrones para detectar el reverso del carnet
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        leading: IconButton(
          onPressed: () => widget.onValidationComplete(false, null),
    ...
    switch (step.status) {
      ...
      case StepStatus.failed:
        return Container(
          ...
          child: const Icon(Icons.close, color: AppColors.iconSecondary, size: 22),
        );
      default:
        return Container(
          width: 30,
